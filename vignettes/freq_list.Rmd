...
Currently, this function accepts an n-dimensional table as input, and then tabulates every full combination of values observed, calculates the frequency and cumulative frequencies.
